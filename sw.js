const C='bali-v18-safe-1',A=['./manifest.webmanifest','./icon-192.png','./icon-512.png','./v8-theme.css','./v11-fixes.css','./v13-scroll.css','./v12-ui.js','./v13-drag.js','./v14-ui.js','./v15-weather.css','./v15-itinerary.js','./v15-weather.js','./v16-sync.js','./v18-safe.css','./v18-safe.js'];
...
self.addEventListener('fetch',e=>{
  if(e.request.mode==='navigate'){
    e.respondWith(fetch(e.request).then(async r=>{
      let t=await r.text();
      t=t.replace('</head>','<link rel="stylesheet" href="/v8-theme.css?v=18s1"><link rel="stylesheet" href="/v11-fixes.css?v=18s1"><link rel="stylesheet" href="/v13-scroll.css?v=18s1"><link rel="stylesheet" href="/v15-weather.css?v=18s1"><link rel="stylesheet" href="/v18-safe.css?v=18s1"></head>').replace('</body>','<script src="/v12-ui.js?v=18s1"></script><script src="/v13-drag.js?v=18s1"></script><script src="/v14-ui.js?v=18s1"></script><script src="/v15-itinerary.js?v=18s1"></script><script src="/v15-weather.js?v=18s1"></script><script src="/v16-sync.js?v=18s1"></script><script src="/v18-safe.js?v=18s1"></script></body>');
