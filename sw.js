...
self.addEventListener('fetch',e=>{
  if(e.request.mode==='navigate'){
    e.respondWith(fetch(e.request).then(async r=>{
      let t=await r.text();
      t=t.replace('</head>','<link rel="stylesheet" href="/v8-theme.css?v=20.1"><link rel="stylesheet" href="/v11-fixes.css?v=20.1"><link rel="stylesheet" href="/v13-scroll.css?v=20.1"><link rel="stylesheet" href="/v15-weather.css?v=20.1"><link rel="stylesheet" href="/v18-safe.css?v=20.1"><link rel="stylesheet" href="/v19-wishlist.css?v=20.1"></head>').replace('</body>','<script src="/v12-ui.js?v=20.1"></script><script src="/v13-drag.js?v=20.1"></script><script src="/v14-ui.js?v=20.1"></script><script src="/v15-itinerary.js?v=20.1"></script><script src="/v15-weather.js?v=20.1"></script><script src="/v20-sync-bridge.js?v=20.1"></script><script src="/v16-sync.js?v=20.1"></script><script src="/v18-safe.js?v=20.1"></script><script src="/v18-route-hotfix.js?v=20.1"></script><script src="/v18-pack-edit.js?v=20.1"></script><script src="/v19-wishlist.js?v=20.1"></script></body>');
